		...
		changeState: function(b) {
			...
			if (a.cache.states[a.stateId]) c = a.cache.states[a.stateId];
				...
				if (!(f = a.getCachedElement(g))) {
					var l;
					l = b + e;
					f = a.cacheElement(g, a.newInline("body{min-width:" + l + "}.container{margin-left:auto;margin-right:auto;width:" + l + "}.container.small{width:" + (0.75 * b + e) + "}.container.signup{width:" + (0.25 * b + e) + "}.container.big{width:100%;max-width:" + (1.25 * b + e) + ";min-width:" + l + "}"), "head", 3)
				}
				c.elements.push(f);
				g = "iG";
